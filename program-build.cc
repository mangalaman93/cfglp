...
basic_Block::basic_Block(int num, ast_List_Ptr asl, int line)
{
    bb_num = num;
    ast_list = asl;
    lineno = line;
...
bb_Ptr basic_Block::get_True_Successor() {return true_goto;}

bb_Ptr basic_Block::get_False_Successor() {return false_goto;}

int basic_Block::get_Line_Number() {return lineno;}

void basic_Block::set_Ast_List(ast_List_Ptr l_ptr) {ast_list = l_ptr;}

void basic_Block::setSuccessor(bb_Ptr true_S, bb_Ptr false_S) {
  true_goto = true_S;
  false_goto = false_S;
}
