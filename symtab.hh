...
typedef enum {entity_Var=1, entity_Proc} entity_Type;
...
*                                 /    \
*                               /        \
*                   sym_Entry_for_Var   sym_Entry_for_Proc
*                        /    \
*                      /        \
*     sym_Entry_for_Int_Var   sym_Entry_for_float_Var                
*/
...
class sym_Entry
{
  ...
  public:
    ...
    virtual void set_Ivalue(int num) ;
    virtual int get_Ivalue() ;
    virtual void set_Fvalue(double num);
    virtual double get_Fvalue();
	...
	/* abstract class for variable type entry*/
class sym_Entry_for_Var : public sym_Entry
{
	  /* A local variable gets defined when a value is assigned to it */
